...
const Qualifications = () => {
  return (
    <div className='text-black bg-white relative w-full h-screen p-6 text-2xl'>
      <div className="fadeText animate-fadeText delay-100 text-4xl pb-6">Education</div>
      <div className='fadeText animate-fadeText delay-400 font-semibold'>GCSE: </div>
      <div className='fadeText animate-fadeText delay-800 '>Geography: 7 </div>      
      <div className='fadeText animate-fadeText delay-1200 '>Computer Science: 7</div>
      <div className='fadeText animate-fadeText delay-1600 '>Maths: 7</div>
      <div className='fadeText animate-fadeText delay-2000 '>English Literature: 6</div>
      ...
      <div className='fadeText animate-fadeText delay-3600 font-semibold'>A Level: </div>
      ...
      <div className='fadeText animate-fadeText delay-5200'>Computer Science: D</div>
    </div>
